...
import com.nz.log.JnaWinToolsLogger;
import com.nz.log.MuttedJnaWinToolsLogger;
import com.nz.lol.copilot.overlay.service.app.window.utils.win.result.*;
import com.nz.result.*;
...
public class Window64Helper {
    ...
    public Window64Helper(JnaWinToolsLogger logger) {
        this.logger = logger;
    }

    public Window64Helper() {
        this(new MuttedJnaWinToolsLogger());
    }
    ...
    private <T extends WinApiResult> T withWindowName(
        ...
        logger.debug("Start action {} for window={}", action, windowName);
    ...
    private <T extends WinApiResult> T withHwnd(
        ...
        String windowName = nameResult.isFailure() ? nameResult.getResult() : "NO_NAME_FOUND";
